...
PlotKit.CanvasRenderer.prototype.__init__ = function(element, layout, options) {
    ...
    this.options = {
        ...
        "axisLabelFontSize": 9,
        "axisLabelWidth": 50,
        "barLabelFormatter": function(value) { return value; },
        "pieRadius": 0.4,
        "enableEvents": true
    };
...
PlotKit.CanvasRenderer.prototype._renderBarChart = function() {
    ...
    var drawRect = function(context, bar) {
        ...
        var label = DIV(labelStyle, this.options.barLabelFormatter(bar.yval));
        label.style.top = (y - 20) + "px";
        label.style.left = (x - this.options.axisLabelWidth/2 + w/2) + "px";
